...
//        Dataset<Row> results = spark.sql("SELECT county FROM people");
        ...
        df1.repartition(1).write().json("file:///Users/zzx/Downloads/result1.json");
        ...
        df2.sort(asc("date")).repartition(1).write().json("file:///Users/zzx/Downloads/result2.json");
        ...
        df3.sort("totalCases").repartition(1).write().json("file:///Users/zzx/Downloads/result3.json");
...
// 8.统计截止5.19全美和各州的病死率
        ...
        df8.sort("sign", "deathRate").repartition(1).write().json("file:///Users/zzx/Downloads/result8.json");
